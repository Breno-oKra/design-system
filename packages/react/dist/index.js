...
var CheckboxIndicator = styled(Checkbox.Indicator, {
  ...
  width: "$4",
  height: "$4",
  // aqui verificamos se o usuario clikou para mascar
  '&[data-state="checked"]': {
    animation: `${slideIn} 200ms ease-out`
  },
  // aqui verificamos se o usuario clikou para desmascar
...
var Steps = styled("div", {
  display: "grid",
  // ex: repeat(4,1fr) porém o numero de repetição sera estabelecido
  // variavel foi passada pelo index
