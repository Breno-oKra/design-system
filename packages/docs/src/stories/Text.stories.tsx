...
import { Text, TextProps } from '@igniteOkra-ui/react'
...
export const CustomTag: StoryObj<TextProps> = {
  args: {
    ...
    // as é uma propriedade do proprio stitches, diferente do styles-component, o stiches permite musar a categoria da tag por atributos
    as: 'strong',
  },
}
